...
public class ModBlocks {
	...
	private static void initializeBlock() {
		...
		red_connector = new ConnectorRedWire(Material.iron, new CableProperties("connector_lv", VoltageTier.LV, 128L, 1L)).setBlockName("red_connector").setHardness(5.0F).setResistance(10.0F).setCreativeTab(MainRegistry.machineTab).setBlockTextureName(RefStrings.MODID + ":red_connector");
		red_connector_super = new ConnectorRedWireSuper(Material.iron, new CableProperties("connector_super_lv", VoltageTier.LV, 128L, 1L)).setBlockName("red_connector_super").setHardness(5.0F).setResistance(10.0F).setCreativeTab(MainRegistry.machineTab).setBlockTextureName(RefStrings.MODID + ":red_connector");
		red_pylon = new PylonRedWire(Material.iron, new CableProperties("pylon_lv", VoltageTier.LV, 128L, 1L)).setBlockName("red_pylon").setHardness(5.0F).setResistance(10.0F).setCreativeTab(MainRegistry.machineTab).setBlockTextureName(RefStrings.MODID + ":red_pylon");
		red_pylon_steel = new PylonRedWire(Material.iron, new CableProperties("pylon_steel_lv", VoltageTier.LV, 128L, 1L)).setBlockName("red_pylon_steel").setHardness(5.0F).setResistance(10.0F).setCreativeTab(MainRegistry.machineTab).setBlockTextureName(RefStrings.MODID + ":red_pylon");
		red_pylon_medium_wood = new PylonMedium(Material.wood, new CableProperties("pylon_medium_mv", VoltageTier.MV, 512L, 2L)).setBlockName("red_pylon_medium_wood").setHardness(5.0F).setResistance(10.0F).setCreativeTab(MainRegistry.machineTab).setBlockTextureName(RefStrings.MODID + ":red_pylon");
		red_pylon_medium_wood_transformer = new PylonMedium(Material.wood, new CableProperties("pylon_medium_transformer_mv", VoltageTier.MV, 512L, 2L)).setBlockName("red_pylon_medium_wood_transformer").setHardness(5.0F).setResistance(10.0F).setCreativeTab(MainRegistry.machineTab).setBlockTextureName(RefStrings.MODID + ":red_pylon");
		red_pylon_medium_steel = new PylonMedium(Material.iron, new CableProperties("pylon_medium_steel_mv", VoltageTier.MV, 512L, 2L)).setBlockName("red_pylon_medium_steel").setHardness(5.0F).setResistance(10.0F).setCreativeTab(MainRegistry.machineTab).setBlockTextureName(RefStrings.MODID + ":red_pylon");
		red_pylon_medium_steel_transformer = new PylonMedium(Material.iron, new CableProperties("pylon_medium_steel_transformer_mv", VoltageTier.MV, 512L, 2L)).setBlockName("red_pylon_medium_steel_transformer").setHardness(5.0F).setResistance(10.0F).setCreativeTab(MainRegistry.machineTab).setBlockTextureName(RefStrings.MODID + ":red_pylon");
		red_pylon_large = new PylonLarge(Material.iron, new CableProperties("pylon_large_hv", VoltageTier.HV, 2_048L, 4L)).setBlockName("red_pylon_large").setHardness(5.0F).setResistance(10.0F).setCreativeTab(MainRegistry.machineTab).setBlockTextureName(RefStrings.MODID + ":red_pylon_large");
		substation = new Substation(Material.iron, new CableProperties("substation_hv", VoltageTier.HV, 2_048L, 4L)).setBlockName("substation").setHardness(5.0F).setResistance(10.0F).setCreativeTab(MainRegistry.machineTab).setBlockTextureName(RefStrings.MODID + ":substation");
