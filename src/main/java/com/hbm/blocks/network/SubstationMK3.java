...
import com.hbm.tileentity.network.TileEntitySubstationMK3;
...
public class SubstationMK3 extends BlockDummyable {

	public SubstationMK3() {
		super(Material.iron);
	}

	@Override
	public TileEntity createNewTileEntity(World world, int meta) {
		if(meta >= 12) return new TileEntitySubstationMK3();
		return null;
	}

	@Override
	public int[] getDimensions() { return new int[] {6, 0, 1, -1, 1, -1}; }
	@Override
