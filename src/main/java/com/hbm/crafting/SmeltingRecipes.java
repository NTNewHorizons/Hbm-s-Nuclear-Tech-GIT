...
public class SmeltingRecipes {
	...
	public static void AddSmeltingRec()
	{
		...
		// Rich ore chunks smelt exactly like their regular ore blocks (x1)
		GameRegistry.addSmelting(new ItemStack(ModItems.chunk_rich, 1, Mats.MAT_IRON.id), new ItemStack(Items.iron_ingot), 0.7F);
		GameRegistry.addSmelting(new ItemStack(ModItems.chunk_rich, 1, Mats.MAT_COPPER.id), new ItemStack(ModItems.ingot_copper), 2.5F);
		GameRegistry.addSmelting(new ItemStack(ModItems.chunk_rich, 1, Mats.MAT_ALUMINIUM.id), new ItemStack(ModItems.ingot_aluminium), 1.0F);
		GameRegistry.addSmelting(new ItemStack(ModItems.chunk_rich, 1, Mats.MAT_ASBESTOS.id), new ItemStack(ModItems.ingot_asbestos), 1.0F);
		GameRegistry.addSmelting(new ItemStack(ModItems.chunk_rich, 1, Mats.MAT_BERYLLIUM.id), new ItemStack(ModItems.ingot_beryllium), 2.0F);
		GameRegistry.addSmelting(new ItemStack(ModItems.chunk_rich, 1, Mats.MAT_COAL.id), new ItemStack(Items.coal), 0.1F);
		GameRegistry.addSmelting(new ItemStack(ModItems.chunk_rich, 1, Mats.MAT_DIAMOND.id), new ItemStack(Items.diamond), 1.0F);
		GameRegistry.addSmelting(new ItemStack(ModItems.chunk_rich, 1, Mats.MAT_FLUORITE.id), new ItemStack(ModItems.fluorite), 1.0F);
		GameRegistry.addSmelting(new ItemStack(ModItems.chunk_rich, 1, Mats.MAT_GOLD.id), new ItemStack(Items.gold_ingot), 1.0F);
		GameRegistry.addSmelting(new ItemStack(ModItems.chunk_rich, 1, Mats.MAT_LAPIS.id), new ItemStack(Items.dye, 1, 4), 0.2F);
		GameRegistry.addSmelting(new ItemStack(ModItems.chunk_rich, 1, Mats.MAT_LEAD.id), new ItemStack(ModItems.ingot_lead), 3.0F);
		GameRegistry.addSmelting(new ItemStack(ModItems.chunk_rich, 1, Mats.MAT_LIGNITE.id), new ItemStack(ModItems.lignite), 1.0F);
		GameRegistry.addSmelting(new ItemStack(ModItems.chunk_rich, 1, Mats.MAT_LITHIUM.id), new ItemStack(ModItems.lithium), 1.0F);
		GameRegistry.addSmelting(new ItemStack(ModItems.chunk_rich, 1, Mats.MAT_KNO.id), new ItemStack(ModItems.niter), 1.0F);
		GameRegistry.addSmelting(new ItemStack(ModItems.chunk_rich, 1, Mats.MAT_REDSTONE.id), new ItemStack(Items.redstone), 0.7F);
		GameRegistry.addSmelting(new ItemStack(ModItems.chunk_rich, 1, Mats.MAT_SULFUR.id), new ItemStack(ModItems.sulfur), 1.0F);
		GameRegistry.addSmelting(new ItemStack(ModItems.chunk_rich, 1, Mats.MAT_THORIUM.id), new ItemStack(ModItems.ingot_th232), 3.0F);
		GameRegistry.addSmelting(new ItemStack(ModItems.chunk_rich, 1, Mats.MAT_TITANIUM.id), new ItemStack(ModItems.ingot_titanium), 3.0F);
		GameRegistry.addSmelting(new ItemStack(ModItems.chunk_rich, 1, Mats.MAT_TUNGSTEN.id), new ItemStack(ModItems.ingot_tungsten), 6.0F);
		GameRegistry.addSmelting(new ItemStack(ModItems.chunk_rich, 1, Mats.MAT_URANIUM.id), new ItemStack(ModItems.ingot_uranium), 6.0F);
		GameRegistry.addSmelting(new ItemStack(ModItems.chunk_rich, 1, Mats.MAT_ZINC.id), new ItemStack(ModItems.ingot_zinc), 2.5F);
